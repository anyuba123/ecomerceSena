            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-3 my-2'>
                  ...
                  <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-red-600 hover:text-red-600 hover:bg-white' onClick={(e) => handleAddToCart(e, data?._id)}>Agregar al Carrito</button>
                </div>
