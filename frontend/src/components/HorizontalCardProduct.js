          ...
          data.map((product, index) => {
            return (
              <Link key={index} to={"product/" + product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                <div className='bg-slate-200 h-full p-6 min-w-[150px] md:min-w-[165px]'>
                ...
                <div className='p-3 grid'>
                  <h2 className='text-xs md:text-sm text-ellipsis line-clamp-1 text-black'>{product?.productName}</h2>
